function show_form_a() {
    if (localStorage.getItem("consultorNome") != null) {
        //Tem
        //document.querySelector("#adicionar_comercio_parent").style.display = "block"
        document.querySelector("#precisa_consultor_h1").style.display = "none"

        document.querySelector("#iPesquisarConsultor").classList.remove("ob_hd")
        setTimeout(function () {
            resizeIframe(document.querySelector("#iPesquisarConsultor"))
        }, 250)
        document.querySelector("#adicionar_comercio").style.display = "block"
        //document.querySelector("#btn_voltar").style.display = "block"
    } else {
        //nTem
        //document.querySelector("#adicionar_comercio_parent").style.display = "block"
        //document.querySelector("#adicionar_comercio").style.display = "block"
    ...
    //document.querySelector("#adicionar_comercio").style.display = "flex"
    document.querySelector("#icomercios1").style.display = "none"
}

if (window.location.href != "https://senae.com.br/sebrae/comercios-a-venda/?fl_builder") {
...
function defineEmail() {
    if (localStorage.getItem("consultorId") == null) {
        ...
        document.querySelector(".idConsultor").value = localStorage.getItem("consultorId")
...
function p_entrar_em_contato(cod, titulo) {
    document.querySelector("#comercios_hd").style.display = "none";
    if (localStorage.getItem("consultorNome") != null) {
        document.querySelector("#contato").style.display = "block";
        document.querySelector("#__form_a").style.display = "block";
        document.querySelector("#comercios-page").style.display = "none";
        document.querySelector("#c_j_f .title").value = "Comércio à Venda: " + cod + " - " + titulo;
        resizeIframe(document.querySelector("#iPesquisarConsultor"))
    } else {
        document.querySelector("#contato").style.display = "block";
        document.querySelector("#__form_a").style.display = "none";
        document.querySelector("#comercios-page").style.display = "none";
        document.querySelector("#c_j_f .title").value = "Comércio à Venda: " + cod + " - " + titulo;
        resizeIframe(document.querySelector("#iPesquisarConsultor"))
    }
...
function p_entrar_em_contato_voltar() {
    document.querySelector("#contato").style.display = "none";
    document.querySelector("#comercios-page").style.display = "block";
    //document.querySelector(".your-parceria input").value = ""
}

function hideFormOk() {
    //document.querySelector('#c_j_f').style.display = "none"
}

function showFormOk() {
    document.querySelector('#c_j_f').style.display = "block"
}
...
img1.onchange = evt => {
    ...
    if (file) {
        //urlfavicon.previousElementSibling.src = URL.createObjectURL(file)
        img1.previousElementSibling.setAttribute("style", "background-image:url('" + URL.createObjectURL(file) +
            "');color:#0000")
    }
}
...
img2.onchange = evt => {
    ...
    if (file) {
        //urlfavicon.previousElementSibling.src = URL.createObjectURL(file)
        img2.previousElementSibling.setAttribute("style", "background-image:url('" + URL.createObjectURL(file) +
            "');color:#0000")
    }
}
...
img3.onchange = evt => {
    ...
    if (file) {
        //urlfavicon.previousElementSibling.src = URL.createObjectURL(file)
        img3.previousElementSibling.setAttribute("style", "background-image:url('" + URL.createObjectURL(file) +
            "');color:#0000")
    }
}
...
img4.onchange = evt => {
    ...
    if (file) {
        //urlfavicon.previousElementSibling.src = URL.createObjectURL(file)
        img4.previousElementSibling.setAttribute("style", "background-image:url('" + URL.createObjectURL(file) +
            "');color:#0000")
    }
}
...
img5.onchange = evt => {
    ...
    if (file) {
        //urlfavicon.previousElementSibling.src = URL.createObjectURL(file)
        img5.previousElementSibling.setAttribute("style", "background-image:url('" + URL.createObjectURL(file) +
            "');color:#0000")
    }
}
...
img6.onchange = evt => {
    ...
    if (file) {
        //urlfavicon.previousElementSibling.src = URL.createObjectURL(file)
        img6.previousElementSibling.setAttribute("style", "background-image:url('" + URL.createObjectURL(file) +
            "');color:#0000")
    }
}
...
img7.onchange = evt => {
    ...
    if (file) {
        //urlfavicon.previousElementSibling.src = URL.createObjectURL(file)
        img7.previousElementSibling.setAttribute("style", "background-image:url('" + URL.createObjectURL(file) +
            "');color:#0000")
    }
}
...
img8.onchange = evt => {
    ...
    if (file) {
        //urlfavicon.previousElementSibling.src = URL.createObjectURL(file)
        img8.previousElementSibling.setAttribute("style", "background-image:url('" + URL.createObjectURL(file) +
            "');color:#0000")
    }
}
...
img9.onchange = evt => {
    ...
    if (file) {
        //urlfavicon.previousElementSibling.src = URL.createObjectURL(file)
        img9.previousElementSibling.setAttribute("style", "background-image:url('" + URL.createObjectURL(file) +
            "');color:#0000")
    }
}

img10.onchange = evt => {
    const [file] = img10.files
    if (file) {
        //urlfavicon.previousElementSibling.src = URL.createObjectURL(file)
        img10.previousElementSibling.setAttribute("style", "background-image:url('" + URL.createObjectURL(
            file) + "');color:#0000")
    }
}
...
setTimeout(function () {
    document.querySelector(".cep").addEventListener("focusout", getLocationCep())
}, 2000)
...
function setcidad() {
    ...
    document.querySelector(".cidade").innerHTML =
        '<select class="cidade" type="text" name="cidade"><option value="0">Cidade</option></select>'

    for (i = 0; i < cidad.length; i++) {
        document.querySelector(".cidade").insertAdjacentHTML('afterbegin', '<option value="' + cidad[i] + '">' +
            cidad[i] + '</option>')
    }
}
*/
